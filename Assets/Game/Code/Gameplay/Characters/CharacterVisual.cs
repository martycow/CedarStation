...
{
    public sealed class CharacterVisual : ContextView<CharacterVisualContext>
    {
        [SerializeField]
        ...
        protected override void Init()
        {
            ...
            _hoodieOffIndex = OutfitJacket.sharedMesh.GetBlendShapeIndex(Const.Character.BlendShapes.HoodieOff);
        }

        protected override void UpdateView()
        {
            OutfitJacket.SetBlendShapeWeight(_hoodieOffIndex, Context.HoodieOn ? 0f : 100f);
        }
